...
public class Main12 {
    public static void main(String[] args) {
        ...
        Main1.ConcertTicketSystem1 ticketSystem = new Main1.ConcertTicketSystem1(rows, cols);
        ...
        do {
            ...
            switch (choice) {
                case '1':
                    ...
                    break;
                case '2':
                    System.out.print("Enter row number: "); int row = scanner.nextInt();
                    System.out.print("Enter column number: "); int col = scanner.nextInt();
